...
<div class="container">
  ...
  <form action="index.php" method="GET">
    ...
    <div class="form-group">
      ...
      <input type="text" value="<?php echo $post->idUserLiaison; ?>" class="form-control" name="prenom" id="exampleInputPrenom1" placeholder="Votre prénom...">
    </div>
    <div class="form-group">
      <label for="InputNom">Nom</label>
      <input type="text" value="<?php echo $post->id_user; ?>" class="form-control" name="nom" id="exampleInputNom1" placeholder="Votre nom...">
    </div>
    <div class="form-group">
